...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অন্য বেডারে Miss না করে মেয়ে হলে বস রিপন রে হাঙ্গা করো😶👻😘",
    ...
    "Ripon": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ MD RIPON RAHMAN NAYON☜\nFacebook: https://www.facebook.com/mdriponrahmannayon\nWhatsApp: +8801600607594",
    "admin": "He is MD RIPON RAHMAN NAYON তাকে সবাই Coding Master হিসেবে চিনে😘☺️",
    "Vabi": "এ তো হাছিনা হে মেরে দিলকি দারকান হে মেরি জান হে😍.",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস রিপন রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস রিপন এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️",
    "ami  ripon": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ★彡[ʀɪᴘᴏɴ~ʙʀᴏ~ʙᴏᴛ]彡★💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss রিপন এর ইনবক্সে গুতা দিন 😘",
